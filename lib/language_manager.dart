...
class LanguageManager extends ChangeNotifier {
  ...
  static const Map<String, String> _enToBn = {
    ...
    'No sleep history': 'স্লিপ হিস্টরি নেই',
    'Maximum 3 sleep records allowed per day!': 'একদিনে সর্বোচ্চ ৩টি স্লিপ রেকর্ড সেভ করা যাবে!',
    'Bed Time!': 'বেড টাইম!',
    'Your sleep session has started. Please put your phone away.': 'আপনার ঘুমের সময় শুরু হয়েছে। দয়া করে ফোনটি দূরে সরিয়ে রাখুন।',
    'Go to Sleep': 'ঘুমাতে যান',
    ...
    'System Defaults': 'সিস্টেম ডিফল্টস',
    'StudyMate Favorites': 'স্টাডিমেট ফেভারিটস',
    'System Default Notification': 'সিস্টেম ডিফল্ট নোটিফিকেশন',
    'System Default Alarm': 'সিস্টেম ডিফল্ট অ্যালার্ম',
    'System Default Ringtone': 'সিস্টেম ডিফল্ট রিংটোন',
